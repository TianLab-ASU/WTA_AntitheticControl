...
dydt=[vm1.*(CNm.*(Rm1./Qm1+1./Qbm1)./PFm)-dm.*M1-Tc1.*C1.*M1-lambda_Glob.*Tc3.*C2.*M1; %M1
      vm2.*(CNm.*(Rm2./Qm2+1./Qbm2)./PFm)-dm.*M2-Tc2.*C2.*M2-lambda_Glob.*Tc4.*C1.*M2; %M2
      vc1.*(CNc.*(Rc1./Qc1+1./Qbc1)./PFm)-dc.*C1-Tc1.*C1.*M1-lambda_Glob.*Tc4.*C1.*M2-lambda_NCR.*Tc5.*C1.*C2; %C1
      vc2.*(CNc.*(Rc2./Qc2+1./Qbc2)./PFm)-dc.*C2-Tc2.*C2.*M2-lambda_Glob.*Tc3.*C2.*M1-lambda_NCR.*Tc5.*C1.*C2; %C2
