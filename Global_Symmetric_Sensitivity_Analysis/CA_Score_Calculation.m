...
for fileIndex = 1:1000
   % Assuming your files are named ...
    % Data_Antithetic_Global_Sym1.mat, Data_Antithetic_Global_Sym2.mat, ..., Data_Antithetic_Global_Sym1000.mat
    filename = ['Data_Antithetic_Global_Sym', num2str(fileIndex), '.mat'];
    load(filename);
